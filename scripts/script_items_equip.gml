...
if (itemType == "weapon")
{
    ...
    currentPlayerId.equippedWeaponTotalActionPoints = ds_map_find_value(global.mapItemWeaponStats,string(itemString)+"_damage");
    currentPlayerId.equippedWeaponDamage = ds_map_find_value(global.mapItemWeaponStats,string(itemString)+"_name");
...
else if (itemType == "armour")
{
    ...
    currentPlayerId.equippedArmourTotalActionPoints = ds_map_find_value(global.mapItemArmourStats,string(itemString)+"_damage");
    currentPlayerId.equippedArmourDamage = ds_map_find_value(global.mapItemArmourStats,string(itemString)+"_name");
